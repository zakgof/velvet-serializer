...
public class Data {
    ...
    private final ArrayList<String> arrayListStrConcr;
    private final List<String> arrayListStr;
    private final List<String> listOfStr;
    private final List<String> arrayAsList;
    private final ArrayList<InnerInterface> polyArrayList;
    ...
    public Data(long seed) {
        ...
        this.primitiveLong = random.nextLong();
        ...
        this.arrayListStrConcr = new ArrayList<>(List.of("foo", "bar"));
        this.listOfStr = List.of("one", "two");
        this.arrayListStr = new ArrayList<>(List.of("hello", "world"));
        this.arrayAsList = Arrays.asList("as", "list");
        this.polyArrayList = new ArrayList<>(Arrays.asList(new InnerFinal(seed + 72), null));

        this.objectByte = (byte) random.nextInt();
        this.objectShort = (short) random.nextInt();
        this.objectInteger = random.nextInt();
        this.objectLong = random.nextLong();
        this.objectBoolean = random.nextInt(2) == 0;
        this.objectCharacter = (char) (random.nextInt(Character.MAX_VALUE + 1));
